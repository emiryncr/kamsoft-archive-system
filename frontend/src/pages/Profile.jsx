              ...
              <div className="space-y-6">
                ...
                {itemsLoading ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {userItems.map(item => (
                      <div key={item._id} className="bg-white border-2 border-gray-200 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                        <img
                          src={item.image}
                          alt={item.title}
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex space-x-2">
                            <Link
                              ...
                              className="flex-1 bg-blue-500 text-white px-3 py-1 rounded text-sm text-center hover:bg-blue-600"
                            >
                              Edit
                            </Link>
                            <button
